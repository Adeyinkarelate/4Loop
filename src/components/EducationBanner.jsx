...
const EducationBanner = () => {
  return (
    <section className="mt-4 px-4 sm:px-0">
      <div className="mx-auto rounded-2xl bg-custom_light_purple px-4 py-8 sm:max-w-[85vw] sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-9">
              ...
              <div className="flex w-fit items-center gap-3 rounded-lg border border-gray-200 bg-white/90 p-3 px-4 shadow-md backdrop-blur">
                <span className="rounded-lg bg-custom_purple-500/20 p-3 text-custom_purple-500">
                  <svg
                    ...
                    className="h-6 w-6 sm:h-7 sm:w-7 fill-purple-700"
                  >
          ...
          <div className="space-y-6 lg:py-16">
            <motion.h2
              ...
              className="text-2xl font-semibold sm:text-[2.6rem] font-out bg-linear-to-r from-purple-800 to-purple-300 bg-transparent bg-clip-text text-transparent"
            >
            ...
            <motion.p
              ...
              className="max-w-md text-base text-gray-400 md:text-lg"
            >
            ...
            <ul className="text-sm text-gray-400 md:text-md">
