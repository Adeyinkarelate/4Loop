...
const PythonFullStack = () => {
  return (
    <>
      <Helmet>
        <title>PythonFullStack| Adexbit's Edutech Academy</title>
        <meta name="title" content="PythonFullStack| Adexbit's Edutech Academy" />
        <meta
          name="description"
        ...
        <meta name="og:title" content="PythonFullStack | Adexbit's Edutech Academy" />
        <meta
          name="og:description"
          content="Adexbit's Edutech Academy is an online tech school where you get to learn new skills in a wide variety of inspiring, interactive workshops. As a student you get to learn web development, data analytics and forex."
        />
        ...
        <div className="md:max-w-[700px] lg:max-w-[800px]">
          ...
          <div className="gap-2 items-center pt-15">
            ...
            <ul className="pt-4 space-y-4 leading-relaxed">
              ...
              <li className="flex items-center gap-3 text-md text-white">
                <IoCheckmark className="text-purple-500" />
                JavaScript & ES6+: DOM, APIs, async programming & modern
                tooling.
              </li>

              <li className="flex items-center gap-3 text-md text-white">
                <IoCheckmark className="text-purple-500" />
                React fundamentals & advanced concepts: components, hooks, state
                management & API integration.
              </li>

              <li className="flex items-center gap-3 text-md text-white">
                <IoCheckmark className="text-purple-500" />
                Python programming: syntax, OOP, modules, file handling &
                scripts.
              </li>
              ...
              <li className="flex items-center gap-3 text-md text-white">
                <IoCheckmark className="text-purple-500" />
                Django REST Framework: serializers, viewsets, JWT auth,
                pagination, documentation & API best practices.
              </li>
          ...
          <div className="gap-2 items-center pt-15">
            ...
            <div className="font-out font-semibold my-2">
              <p className="font-medium pt-2 text-md">
                Timing: Weekdays / Saturday (2pm - 5pm)
              </p>
          ...
          <div className="gap-2 items-center pt-15">
            ...
            <p className="flex items-center gap-3 pt-4 text-white">
              <IoCheckmark className="text-purple-500" />
              Beginners who want to start a career in web or software
              development.
            </p>

            <p className="flex items-center gap-3 pt-4 text-white">
              <IoCheckmark className="text-purple-500" />
              Career switchers moving into backend, frontend, or full-stack
              roles.
            </p>

            <p className="flex items-center gap-3 pt-4 text-white">
              <IoCheckmark className="text-purple-500" />
              Developers seeking strong hands-on Python, Django, React & API
              skills.
            </p>
